...
sap.ui.define([
	...
	return BaseController.extend("moldawski.Orders.controller.Detail", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		/**
		 *@memberOf moldawski.Orders.controller.Detail
		 */
		...
		onDelete : function (oControlEvent) {
			...
			var oItemToDelete = oControlEvent.getParameter("draggedControl");
